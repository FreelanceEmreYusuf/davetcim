...
class ProfileWithAppBar extends StatefulWidget {
  @override
  _ProfileWithAppBarState createState() => _ProfileWithAppBarState();
}

class _ProfileWithAppBarState extends State<ProfileWithAppBar> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBarMenuBackToHomePage(pageName: "Hesabım", isHomnePageIconVisible: true, isNotificationsIconVisible: true, isPopUpMenuActive: true),
        body: Padding(
