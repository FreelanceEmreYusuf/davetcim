...
class GridServicePackageNewUserItem extends StatefulWidget {
  final CorporationPackageServicesModel packageModel;

  GridServicePackageNewUserItem({
    Key key,
    @required this.packageModel,
  }) : super(key: key);

  @override
  _GridServicePackageNewUserItemState createState() =>
      _GridServicePackageNewUserItemState();
}

class _GridServicePackageNewUserItemState
    extends State<GridServicePackageNewUserItem> {
  @override
