...
class GridCorporateServicePoolNewUserForBasket extends StatefulWidget {
  final ServicePoolModel servicePoolModel;

  GridCorporateServicePoolNewUserForBasket({
    Key key,
    @required this.servicePoolModel,
  }) : super(key: key);

  @override
  _GridCorporateServicePoolNewUserForBasketState createState() =>
      _GridCorporateServicePoolNewUserForBasketState();
}

class _GridCorporateServicePoolNewUserForBasketState
    extends State<GridCorporateServicePoolNewUserForBasket> {
