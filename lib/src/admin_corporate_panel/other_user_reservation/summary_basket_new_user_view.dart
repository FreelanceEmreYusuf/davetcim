...
class SummaryBasketNewUserScreen extends StatefulWidget {
  @override
  _SummaryBasketNewUserScreenState createState() => _SummaryBasketNewUserScreenState();
}

class _SummaryBasketNewUserScreenState extends State<SummaryBasketNewUserScreen>
    with AutomaticKeepAliveClientMixin<SummaryBasketNewUserScreen> {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: ()  {
                  ...
                  pdfHelper.createAndShowOfferOtherUserPDF(context);
                },
                child: Text(
  ...
  void createReservationRequest(String description) async{
    ...
    ReservationModel reservationResponse = await model.createNewReservationForCustomer(UserBasketState.userBasket, description);
    if (reservationResponse == null) {
      ...
      notificationViewModel.sendNotificationToUser(context, UserState.corporationId ,
          OtherUserState.id,
  ...
  void navigateToAdminPanelPage(BuildContext context) {
    StateManagement.disposeStates();
