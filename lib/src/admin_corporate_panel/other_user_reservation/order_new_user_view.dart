...
import 'package:davetcim/src/admin_corporate_panel/other_user_reservation/services_package_new_user_view.dart';
...
class OrderNewUserScreen extends StatefulWidget {
  @override
  _OrderNewUserScreenState createState() => _OrderNewUserScreenState();
}

class _OrderNewUserScreenState extends State<OrderNewUserScreen>
    with AutomaticKeepAliveClientMixin<OrderNewUserScreen> {
        ...
        onPressed: ()  {
          if (registerFormKey.currentState.validate()) {
            ...
            if (UserBasketState.userBasket.corporationModel.serviceSelection == CorporationServiceSelectionEnum.customerSelectsBoth
              ...
              Utils.navigateToPage(context, ServicesPackageNewUserView());
            } else {
